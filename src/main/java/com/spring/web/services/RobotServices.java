...
public class RobotServices {
	...
	/*public List<Robots> obtenerRobotsPorTorneoYCategoria(Integer torneoId, Integer categoriaId) {
		return robotRepository.findByCategorias_Torneos_IdAndCategorias_Id(torneoId, categoriaId);
	}*/
}
